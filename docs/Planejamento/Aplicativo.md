...
No início do projeto, foram elaborados sete rich pictures, cada um por um integrante do grupo. Em seguida, foi realiada uma [reunião](../../Atas/ata_07_04), na qual os rich pictures passaram por alguns critérios de avaliação e, a partir deles, foi feita uma escolha. A tabela 1 abaixo apresenta os aplicativos e os rich pictures que cada integrante escolheu abordar. <a id="REF1" href="#REF1">^1^</a>
