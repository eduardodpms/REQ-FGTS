...
|Nome| Função|
|-----|---------|
|[Danielle Soares](https://github.com/danielle-soaress) |  Mediador
|[Enzo Emir](https://github.com/EnzoEmir) |  Mediador
|<span style = "color: orange"> Maria Eduarda</span> | Equipe/Usuária
